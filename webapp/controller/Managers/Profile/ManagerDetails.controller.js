sap.ui.define([
  ...
  return Controller.extend("management.controller.Managers.Profile.ManagerDetails", {
      ...
      _onObjectMatched: function (oEvent) {
          ...
          // Bind the view to the manager data
          ...
          this.loadConsultantsAndTickets(sManagerId);
      },

      loadConsultantsAndTickets: function (sManagerId) {
          ...
          oModel.read("/CONSULTANTIDSet", {
              success: function (oData) {
                  ...
                  this.loadTicketsCreatedByManager(sManagerId);
              }.bind(this),
      ...
      loadTicketsCreatedByManager: function (sManagerId) {
          var oModel = this.getOwnerComponent().getModel();
          oModel.read("/TICKETIDSet", {
              filters: [new Filter("CreatedBy", FilterOperator.EQ, sManagerId)],
